...
public class EditarHuesped extends JFrame{
	...
	public EditarHuesped(Huesped huesped) {
        ...
        txtNombre.setText(huesped.getNombre());//Asignando el nombre
        ...
        txtApellido.setText(huesped.getApellido());//Asignando el apellido
        ...
        txtFechaN.setDate(Fecha.formatearFechaDate(huesped.getFechaNacimiento()));//Asignando la fecha
		...
		txtNacionalidad.setSelectedItem(huesped.getNacionalidad());//Asignando la nacionalidad
        ...
        txtTelefono.setText(huesped.getTelefono()); //Asignando el telefono
		contentPane.add(txtTelefono);
		
		JLabel lblTitulo = new JLabel("REGISTRO HUÉSPED");
		lblTitulo.setBounds(606, 55, 250, 42);
		...
		txtNreserva.setText(String.valueOf(huesped.getIdReserva())); //Asignando el numero de reserva
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(ValidacionesHuesped.verificarFormulario(txtNombre, txtApellido, txtFechaN, txtNacionalidad, txtTelefono)){ 
                    Huesped huespedNuevo = new Huesped(txtNombre.getText().toLowerCase().trim(), txtApellido.getText().toLowerCase().trim(),
					Fecha.formatearFecha(txtFechaN.getDate()),String.valueOf(txtNacionalidad.getSelectedItem()), txtTelefono.getText(),huesped.getIdReserva());
                    huespedNuevo.setId(huesped.getId());
                    int resultado = new HuespedController().modificarHuesped(huespedNuevo);
                    if(resultado==1){
